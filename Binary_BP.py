...
random.seed(0) # to analyze same data
...
def BP(p_branch, generations):
    ...
    #N_array[N_array==0]=np.nan #set 0-values to nan so that they won't be plotted (if I do not want to plot a dead process any further)
